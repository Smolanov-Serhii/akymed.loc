	...
	<main id="main" class="main">
        <section class="banner-grid">
            ...
            <h2 class="banner-grid__list">
                <?php the_field('title_for_list', $post_id)?>
            </h2>
            <div class="banner-grid__grid main-container text">
                <?php
                if( have_rows('main_modules', $post_id) ):
                    while( have_rows('main_modules', $post_id) ) : the_row();
        ...
        <section class="stand">
            <div class="stand__container main-container">
                <h2 class="stand__title section-title">
                    <?php the_field('title-version', $post_id)?>
                </h2>
                <div class="stand__subtitle section-subtitle">
                    <?php the_field('subtitle-versions', $post_id)?>
                </div>
                <div class="stand__list">
                    <?php
                    if( have_rows('versions_list', $post_id) ):
                        while( have_rows('versions_list', $post_id) ) : the_row();
                            $image = get_sub_field('version_image');
        ...
        <section class="features">
            <div class="features__container main-container">
                <h2 class="features__title section-title">
                    <?php the_field('title-features', $post_id)?>
                </h2>
                <div class="features__list">
                    ...
                    if( have_rows('features_list', $post_id) ):
                        while( have_rows('features_list', $post_id) ) : the_row();
                            ...
                            ?>
                            <div class="features__item <?php if ($counter == 9){echo 'features__item-height';}?>">
