...
?>
	<main id="main" class="main">
        ...
        <section class="two-column-img">
            <div class="two-column-img__container main-container">
            ...
            <div class="two-column__container main-container">
                ...
                <p class="two-column__subtitle section-subtitle">The sperm morphology module of QualiSperm is primarily based on mathematical morphology segmentation techniques. A dynamic local threshold operation transforms the grayscale microscope image into a binary matrix.</p>
            </div>
            <div class="two-column__list main-container">
                <div class="two-column__item">
                    <div class="two-column__item-desc">
